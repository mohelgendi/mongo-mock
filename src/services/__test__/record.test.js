...
import testDataResult from "./testData.result.json";

dotenv.config();

import { getRecords, addRandomRecord } from '../record.service.js';

import { groupRecordsByYear } from "../external.service.js"

const DB_STRING = process.env.DB_STRING || "mongodb://localhost:27017/records";
const CODE_KEY = process.env.CODE_KEY, API_URL = process.env.API_URL;
...
describe('MongoDB service', () => {
    ...
    describe('Record Serivces Tests', () => {
        ...
        test('Get Grouped Records (HTTP Mock)', async () => {
          ...
          const res = await fetch(API_URL+"/record/internalService?from=2000-01-01&to=2023-12-31")
